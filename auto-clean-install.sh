...
# Automatic Clean Install - No prompts, just runs
...
echo "🚀 Automatic Clean Install - No Prompts"
echo "======================================="
echo ""
info "Removing all existing installations and installing fresh in home directory"
...
echo ""
log "✨ Automatic clean installation completed successfully!"