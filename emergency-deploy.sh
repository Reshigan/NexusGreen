...
# SolarNexus Emergency Go-Live Deployment
# CRITICAL: This script ensures 100% deployment success
# No Docker builds - uses direct container execution
...
log "🚨 EMERGENCY GO-LIVE DEPLOYMENT"
log "==============================="
...
# Replace SERVER_IP in frontend
sed -i "s/SERVER_IP/$SERVER_IP/g" /tmp/frontend/index.html
...
docker run -d \
  ...
  --network solarnexus-net \
  -p 3000:80 \
  -v /tmp/frontend:/usr/share/nginx/html:ro \
  nginx:alpine
